...
import com.mdali.tes2.viewmodel.ViewModelComp
...
class copyofMainActivity : ComponentActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val viewModel = //hiltViewModel<ViewModelComp>()
    ...
    @Composable
    fun InsertDataUI(onInsertData: (Finance) -> Unit) {
        /*Column(
            Modifier
                .fillMaxWidth()
                .padding(10.dp)
